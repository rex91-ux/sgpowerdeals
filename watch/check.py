...
FACTSHEET_RE = re.compile(
    # NOTE: the filename may carry a suffix between the bracketed rate and
    # ".pdf" — as at 28 Aug 2026 Tuas renamed these to embed the campaign
    # rebate, e.g. powerfix_36_20260828(269.7)-$160_bill_rebate.pdf. The old
    # pattern anchored ")" directly to ".pdf" and so matched NOTHING for
    # PowerFIX 24/36, reporting them as withdrawn while silently losing the
    # ability to detect a real reprice on the two plans that matter most.
